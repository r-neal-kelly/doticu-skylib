...
namespace doticu_skylib {
    ...
    public:
        enum enum_type : value_type
        {
            ...
            OBSERVE_COMBAT_BEHAVIOR     = static_cast<value_type>(1 << 2),
            INSPECT_CORPSE_BEHAVIOR     = static_cast<value_type>(1 << 3),
            REACT_TO_PLAYER_ACTIONS     = static_cast<value_type>(1 << 4),
            COMMENT_ON_FRIENDLY_FIRE    = static_cast<value_type>(1 << 5),
            ALLOW_AGGRO_RADIUS_BEHAVIOR = static_cast<value_type>(1 << 6),

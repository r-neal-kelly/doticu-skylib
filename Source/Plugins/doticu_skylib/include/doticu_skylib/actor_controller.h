...
namespace doticu_skylib {
    ...
    class Actor_Controller_t :          // bhkCharacterController
        public Dynatomic_Count_t,       // 000
        public Event_Source_t<void*>    // 010
    {
    public:
        virtual ~Actor_Controller_t(); // 0
    ...
    public:
        ...
        u64                         unk_2A0;                    // 2A0
        u64                         unk_2A8;                    // 2A8
        Havok_Rigid_Body_t*         support_body;               // 2B0
        Float_t                     bumped_force;               // 2B8
        u32                         pad_2BC;                    // 2BC
        Havok_Rigid_Body_t*         bumped_body;                // 2C0
        Havok_Rigid_Body_t*         bumped_collision_body;      // 2C8
    ...
    STATIC_ASSERT(sizeof(Actor_Controller_t) == 0x330);

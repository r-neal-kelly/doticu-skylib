...
namespace doticu_skylib {
    ...
    typedef u32 Actor_Base_Flags_t;
    enum class Actor_Base_Flags_e : Actor_Base_Flags_t
    {
        IS_FEMALE                       = 1lu << 0,
        IS_ESSENTIAL                    = 1lu << 1,
    ...
    typedef u16 Actor_Base_Template_Flags_t;
    enum class Actor_Base_Template_Flags_e : Actor_Base_Template_Flags_t
    {
        TRAITS              = 1lu << 0,
        STATS               = 1lu << 1,
        FACTIONS            = 1lu << 2,
    ...
    public:
        ...
        Actor_Base_Flags_t          actor_base_flags;           // 08
        ...
        Actor_Base_Template_Flags_t actor_base_template_flags;  // 1A

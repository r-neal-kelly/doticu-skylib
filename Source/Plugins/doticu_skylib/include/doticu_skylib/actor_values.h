...
namespace doticu_skylib {
    ...
    public:
        ...
        virtual void    Do_Mod_Actor_Value(Actor_Value_e::value_type type, Float_t value);                                      // 5
        virtual void    Do_Restore_Actor_Value(Actor_Value_Modifier_e::value_type modifier, Actor_Value_e type, Float_t value); // 6

...
namespace doticu_skylib { namespace Filter {
    ...
    class Base_Form_Types_t : public Filter_i<Filterable_t>
    {
    public:
        Base_Form_Types_t(State_c<Filterable_t>& state) :
        ...
        public:
            ...
            {
                return Compare_f<Form_t*, Arg_a>::Run<MODE>(filterable->base_form(), arg_a);
            }
        };
